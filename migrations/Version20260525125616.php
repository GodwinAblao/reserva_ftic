 ...
 */
final class Version20260525125616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mentor_custom_request ADD scheduled_date DATE DEFAULT NULL, ADD scheduled_time VARCHAR(50) DEFAULT NULL, ADD meeting_type VARCHAR(50) DEFAULT NULL, ADD meeting_link VARCHAR(500) DEFAULT NULL, ADD meeting_location VARCHAR(255) DEFAULT NULL, ADD facility_id INT DEFAULT NULL, ADD facility_name VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE mentor_profile ADD availability_days JSON DEFAULT NULL, DROP availability_day, CHANGE engagement_points engagement_points INT NOT NULL');
        ...
        $this->addSql('DROP INDEX idx_mentoring_audit_performed_by ON mentoring_audit_log');
        $this->addSql('CREATE INDEX IDX_C8A22ECE2E65C292 ON mentoring_audit_log (performed_by_id)');
        ...
        $this->addSql('DROP INDEX idx_reservation_status_log_reservation ON reservation_status_log');
        $this->addSql('DROP INDEX idx_reservation_status_log_user ON reservation_status_log');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mentoring_audit_log DROP FOREIGN KEY FK_C8A22ECE2E65C292');
        $this->addSql('DROP INDEX idx_c8a22ece2e65c292 ON mentoring_audit_log');
        $this->addSql('CREATE INDEX IDX_mentoring_audit_performed_by ON mentoring_audit_log (performed_by_id)');
        $this->addSql('ALTER TABLE mentoring_audit_log ADD CONSTRAINT FK_C8A22ECE2E65C292 FOREIGN KEY (performed_by_id) REFERENCES `user` (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE mentor_custom_request DROP scheduled_date, DROP scheduled_time, DROP meeting_type, DROP meeting_link, DROP meeting_location, DROP facility_id, DROP facility_name');
        ...
        $this->addSql('ALTER TABLE mentor_profile ADD availability_day VARCHAR(100) DEFAULT NULL, DROP availability_days, CHANGE engagement_points engagement_points INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('CREATE INDEX idx_reservation_status_log_reservation ON reservation_status_log (reservation_id)');
        $this->addSql('CREATE INDEX idx_reservation_status_log_user ON reservation_status_log (changed_by_id)');
    }
}
