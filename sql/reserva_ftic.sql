...
CREATE TABLE IF NOT EXISTS `mentor_profile` (
	...
	PRIMARY KEY(`id`),
	CONSTRAINT FK_185C512AA76ED395 FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mentor_application` (
	...
	PRIMARY KEY(`id`),
	CONSTRAINT FK_E001ECD7CB944F1A FOREIGN KEY (`student_id`) REFERENCES `user` (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mentor_availability` (
	...
	PRIMARY KEY(`id`),
	CONSTRAINT FK_CB274DDFDB403044 FOREIGN KEY (`mentor_id`) REFERENCES `mentor_profile` (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mentoring_appointment` (
	...
	PRIMARY KEY(`id`),
	CONSTRAINT FK_8538E640CB944F1A FOREIGN KEY (`student_id`) REFERENCES `user` (`id`),
	CONSTRAINT FK_8538E640DB403044 FOREIGN KEY (`mentor_id`) REFERENCES `mentor_profile` (`id`),
...
INSERT INTO `user` (`email`, `roles`, `password`, `identification`, `institutional_email`, `is_verified`, `verification_code`, `first_name`, `middle_name`, `last_name`, `degree`, `degree_name`, `profile_picture`) VALUES
	...
	('faculty.test@feutech.edu.ph', '["ROLE_FACULTY", "ROLE_USER"]', '$2y$10$v442gQr85NGBS6zxvVX8b.DjPSrhiURe1hKOpOzhz2O2HZkZqaYm6', 'FAC-TEST-001', 'faculty.test@feutech.edu.ph', 1, NULL, 'Faculty', NULL, 'Tester', NULL, NULL, NULL);
